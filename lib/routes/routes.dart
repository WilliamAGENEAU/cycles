...
class RouteConfiguration {
  ...
  static List<Path> paths = [
    ...
    Path(
      r'^' + AnalysePage.analysePageRoute,
      (context, matches) => AnalysePage(),
    ),
    Path(r'^' + SaisiePage.saisiePageRoute, (context, matches) => SaisiePage()),
    Path(
      r'^' + CalendrierPage.calendrierPageRoute,
      (context, matches) => CalendrierPage(),
    ),
    Path(
      r'^' + HistoriquePage.historiquePageRoute,
      (context, matches) => HistoriquePage(),
    ),
  ];
